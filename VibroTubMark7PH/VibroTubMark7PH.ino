...
void setup() {
  ...
  *******************************************************/
  ...
  studentPiper(selectedTrack); // DEFAULT BEHAVIOURS FOR TRACK
...
void studentPiper(int selectedTrack) {
  ...
  *************************/
  ...
  if (selectedTrack <= lastPin && selectedTrack >= 10) {
...
void electrodeTouchBehaviours(int electrode) {
  ...
  ********************************************/
  if (electrode <= lastPin && electrode >= firstPin && electrode != connectedElectrode) {
    ...
    studentPiper(selectedTrack); //project specific behaviours
  }
...
void FillLEDsFromPaletteColors( uint8_t colorIndex)
{
  if (sequenceMode) {
    ...
    }else if(selectedTrack==12){
      fill_solid(leds,NUM_LEDS,CRGB::Yellow);
    }else if(selectedTrack==13){
      fill_solid(leds,NUM_LEDS,CRGB::Green);
    }else if(selectedTrack==14){
      fill_solid(leds,NUM_LEDS,CRGB::Black);
    }else if(selectedTrack==15){
